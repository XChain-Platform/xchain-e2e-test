...
function registerFixedResolverTest() {
...
function registerRecoveryIdentityTest() {
...
describe('Delegated reward SOURCE RESOLUTION on real on-chain data (d0abcfd / 828db2d)', function () {
    ...
    registerEffectiveSetTest()
    registerFixedResolverTest()
    registerRecoveryIdentityTest()
    registerSlashExclusionTest()
})
